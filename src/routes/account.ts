...
import { createVerifyPassword } from "../controllers/account/create-verify-password.js";
...
router.post("/password-verify", authenticate, (req, res) => {
  createVerifyPassword(req, res);
});
